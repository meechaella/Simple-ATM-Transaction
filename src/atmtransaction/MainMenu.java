...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("FOR YOUR DESIRED TRANSACTION");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel6.setText("Balance Inquiry");

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel7.setText("Withdraw Cash ");
        ...
        jLabelDeposit.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabelDepositMouseClicked(evt);
            }
        });
        ...
        jLabelBalanceInquiry.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabelBalanceInquiryMouseClicked(evt);
            }
        });
    ...
    private void jLabelBalanceInquiryMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBalanceInquiryMouseClicked
        //if "Balance Inquiry" label is clicked
        //proceed to source account selection screen and pass the account number
        SourceAccountSelection sourceAccScreen = new SourceAccountSelection(accountNumber);
        sourceAccScreen.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jLabelBalanceInquiryMouseClicked

    private void jLabelWithdrawMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelWithdrawMouseClicked
        //if "Withdraw Cash" label is clicked
        //proceed to enter amount screen and pass the account number
        String action = "withdraw"; 
        EnterAmount enterAmountScreen = new EnterAmount(action, accountNumber);
        enterAmountScreen.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jLabelWithdrawMouseClicked

    private void jLabelDepositMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelDepositMouseClicked
        //if "Cash Deposit" label is clicked
        //proceed to enter amount screen and pass the account number
        String action = "deposit"; 
        EnterAmount enterAmountScreen = new EnterAmount(action, accountNumber);
        enterAmountScreen.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jLabelDepositMouseClicked
